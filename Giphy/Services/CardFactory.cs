using AdaptiveCards;
using Giphy.Models.Bot;
using Giphy.Models.Giphy;
...
namespace Giphy.Services
{
    public static class CardFactory
    {
        ...
        public static AdaptiveCard CreateResultsCard(AdaptiveCardModel model, List<Datum> images)
        {
            ...
            cancelObject.Action = ActionType.Cancel;
            cancelObject.Card = CardType.Selection;
            ...
            moreObject.Action = ActionType.Ok;
            moreObject.Card = CardType.Search;
        ...
        public static List<AdaptiveElement> AdaptiveImageBuilder(List<Datum> images)
        {
            ...
            {
                returnList.Add(new AdaptiveImage()
                {
                    ...
                    SelectAction = new AdaptiveSubmitAction()
                    {
                        Data = new JObject
                        {
                            {"action", "Ok" },
                            {"card", "Selection" },
                            {"url", item.Images.DownsizedLarge.Url.AbsoluteUri }
                        }
                    }
                });
            }
